        ...
        <div class="mc-container" style="width: 100%; height: 100%;">
            <div class="mc-header">
                ...
                <div style="float: right; color: white; margin-top: 28px; margin-right: 250px; ">
                    欢迎回来，<?php Global $user; print $user->name; ?> | <a style="color: white;" href="/alens/user/logout">登出</a>
                </div>
            </div>
                ...
                <div class="mc-content-actions">
                    <div class="mc-full-column">
                        <div class="mc-full-item color1" onclick="create_topic();">
                            <div class="mc-item-icon">
                                <img width="60px" height="60px" src="/alens/<?php echo drupal_get_path('theme', 'alens') ?>/mc_src/images/MB_0005_Camera.png" />
                            </div>
                        ...
                        <div class="mc-full-item color2" onclick="create_footprint();">
                            <div class="mc-item-icon">
                                <img width="60px" height="60px" src="/alens/<?php echo drupal_get_path('theme', 'alens') ?>/mc_src/images/MB_0018_note1.png" />
                            </div>
                            <div class="mc-item-text">
                                发布日志
                            </div>
                    ...
                    <div class="mc-full-column">
                        <div class='mc-full-item color4' onclick="go_to_imagewall();">
                            <div class="mc-item-icon">
                                <img width="60px" height="60px" src="/alens/<?php echo drupal_get_path('theme', 'alens') ?>/mc_src/images/MB_0012_landskape.png" />
                            </div>
                            <div class="mc-item-text">
                                管理画廊
                            </div>
...
<?php print $page['content']['system_main']['main']['#markup']; ?>
                    ...
                    <div class="mc-full-column">
                        <div class="mc-full-item color6" onclick="go_to_managetopic();">
                            <div class="mc-item-icon">
                                <img width="60px" height="60px" src="/alens/<?php echo drupal_get_path('theme', 'alens') ?>/mc_src/images/MB_0011_macro.png" />
                            </div>
                            <div class="mc-item-text">
                                管理作品
                            </div>
                        ...
                        <div class="mc-full-item color7" onclick="go_to_managefootprint();">
                            <div class="mc-item-icon">
                                <img width="60px" height="60px" src="/alens/<?php echo drupal_get_path('theme', 'alens') ?>/mc_src/images/MB_0017_note2.png" />
                            </div>
                            <div class="mc-item-text">
                                管理日志
                            </div>
                    ...
                    <div class="mc-semi-column">
                        <div class="mc-semi-item color9">
                            <div style="padding:30px;">
                                <img width="60px" height="60px" src="/alens/<?php echo drupal_get_path('theme', 'alens') ?>/mc_src/images/MB_0021_tools.png"/>
                            </div>
                        </div>
                        <div class="mc-semi-item color10">
                            <div style="padding:30px;">
                                <img width="60px" height="60px" src="/alens/<?php echo drupal_get_path('theme', 'alens') ?>/mc_src/images/MB_0018_help.png"/>
                            </div>
                        </div>
                        <div class="mc-semi-item color11" onclick="go_to_home();">
                            <div style="padding:30px;" >
                                <img width="60px" height="60px" src="/alens/<?php echo drupal_get_path('theme', 'alens') ?>/mc_src/images/MB_0023_home2.png"/>
                            </div>
                        </div>
                    </div>
                </div>
