...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="/alens/<?php echo drupal_get_path('theme', 'alens') ?>/mc_src/css/upload/jquery.fileupload-ui.css">
        <!-- CSS adjustments for browsers with JavaScript disabled -->
        <noscript><link rel="stylesheet" href="/alens/<?php echo drupal_get_path('theme', 'alens') ?>/mc_src/css/upload/jquery.fileupload-ui-noscript.css"></noscript>
        <style>
    ...
    <body style="background-color:  white; background-image:  none; height: auto;">
        ...
        <script src="/alens/<?php echo drupal_get_path('theme', 'alens') ?>/mc_src/js/upload/vendor/jquery.ui.widget.js"></script>
        <!-- The jQuery UI widget factory, can be omitted if jQuery UI is already included -->
        ...
        <script src="/alens/<?php echo drupal_get_path('theme', 'alens') ?>/mc_src/js/upload/jquery.iframe-transport.js"></script>
        <!-- The basic File Upload plugin -->
        <script src="/alens/<?php echo drupal_get_path('theme', 'alens') ?>/mc_src/js/upload/jquery.fileupload.js"></script>
        <!-- The File Upload processing plugin -->
        <script src="/alens/<?php echo drupal_get_path('theme', 'alens') ?>/mc_src/js/upload/jquery.fileupload-process.js"></script>
        <!-- The File Upload image preview & resize plugin -->
        <script src="/alens/<?php echo drupal_get_path('theme', 'alens') ?>/mc_src/js/upload/jquery.fileupload-image.js"></script>
        <!-- The File Upload audio preview plugin -->
        <script src="/alens/<?php echo drupal_get_path('theme', 'alens') ?>/mc_src/js/upload/jquery.fileupload-audio.js"></script>
        <!-- The File Upload video preview plugin -->
        <script src="/alens/<?php echo drupal_get_path('theme', 'alens') ?>/mc_src/js/upload/jquery.fileupload-video.js"></script>
        <!-- The File Upload validation plugin -->
        <script src="/alens/<?php echo drupal_get_path('theme', 'alens') ?>/mc_src/js/upload/jquery.fileupload-validate.js"></script>
        <!-- The File Upload Angular JS module -->
        <script src="/alens/<?php echo drupal_get_path('theme', 'alens') ?>/mc_src/js/upload/jquery.fileupload-angular.js"></script>
        <!-- The main application script -->
        <script src="/alens/<?php echo drupal_get_path('theme', 'alens') ?>/mc_src/js/upload/app.js"></script>
        ...
        <script>
            function saveTopicName(){
                ...
                $.ajax({
                    type: 'post',
                    url: '/alens/mc/savetopicname/'+id+'/'+name+'/'+description,
