...
<html lang="en">
    <head>
        ...
        <link type="text/css" rel="stylesheet" href="/alens/<?php echo drupal_get_path('theme', 'alens') ?>/mc_src/css/jquery-te/jquery-te-1.4.0.css">
        <link rel="stylesheet" href="http://netdna.bootstrapcdn.com/bootstrap/3.0.0/css/bootstrap.min.css">
        
        <script type="text/javascript" src="http://code.jquery.com/jquery.min.js" charset="utf-8"></script>
        <script type="text/javascript" src="/alens/<?php echo drupal_get_path('theme', 'alens') ?>/mc_src/js/jquery-te/jquery-te-1.4.0.min.js" charset="utf-8"></script>
